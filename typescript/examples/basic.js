/**
 * basic.js - download one thumbnail to a file.
 *
 * Usage:
 *   node basic.js https://www.python.org/static/img/python-logo.png thumb.jpg
 */

import { writeFileSync } from "node:fs";
import { Client } from "../src/index.js";

async function thumbnail(url, path) {
...
async function main() {
  ...
  if (!url || !path) {
    console.error("usage: node basic.js <url> <out.jpg>");
    process.exit(2);
  }
